...
/**
 * G-04 fitness: ArchUnit rules for budget-service (scaffolded; grows with implementation).
 */
class ArchitectureRulesTest {
    ...
    static void importClasses() {
        classes = new ClassFileImporter().importPackages("com.dailyexpense.budget");
    }
    ...
    void noImportsFromOtherBoundedContexts() {
        noClasses()
            .that().resideInAPackage("com.dailyexpense.budget..")
