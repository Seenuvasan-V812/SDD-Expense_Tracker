...
/**
 * G-04 fitness: ArchUnit rules for category-service (scaffolded; grows with implementation).
 */
class ArchitectureRulesTest {
    ...
    static void importClasses() {
        classes = new ClassFileImporter().importPackages("com.dailyexpense.category");
    }
    ...
    void noImportsFromOtherBoundedContexts() {
        noClasses()
            .that().resideInAPackage("com.dailyexpense.category..")
